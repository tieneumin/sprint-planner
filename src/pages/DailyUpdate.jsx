...
const DailyUpdate = () => {
  ...
  const { activeSprint, getSprintProgress, getTodayCheckin, saveDailyUpdate } =
    useSprintManager();
  ...
  }, [activeSprint]); // Remove getTodayCheckin from dependencies
  ...
  const getTotalHoursToday = () => {
    return goalUpdates.reduce((sum, update) => {
      const hours =
        update.hoursWorked === "" ? 0 : parseFloat(update.hoursWorked) || 0;
      return sum + hours;
    }, 0);
  };
            ...
            <Box display="flex" flexWrap="wrap" gap={1} mb={2}>
              {activeSprint.goals.map((goal) => (
                <Chip
                  ...
                  disabled={
                    !focusGoals.includes(goal.id) && focusGoals.length >= 3
                  }
                />
              ))}
            </Box>
              ...
              <CardContent>
                ...
                <Grid container spacing={2}>
                  ...
                  <Grid item xs={6} sm={3}>
                    ...
                    <Typography variant="h6">
                      {goalUpdates.filter((u) => u.completed).length}/
                      {goalUpdates.length}
                    </Typography>
                  </Grid>
                  ...
                  <Grid item xs={6} sm={3}>
                    ...
                    <Typography variant="h6">{focusGoals.length}/3</Typography>
                  </Grid>
