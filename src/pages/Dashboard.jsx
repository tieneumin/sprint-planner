...
const Dashboard = () => {
  ...
  const { activeSprint, loading, getSprintProgress, getTodayCheckin } = useSprintManager();
    ...
    return (
      <Container maxWidth="lg" sx={{ mt: 6 }}>
        <Box textAlign="center" py={8}>
          ...
          >
            Transform your academic productivity with weekly sprints. Set clear goals, 
            track daily progress, and build better study habits.
          </Typography>
          <Button
            variant="contained"
            size="large"
      ...
      <Grid container spacing={3}>
                  ...
                  <Box display="flex" alignItems="center" gap={2}>
                    <Box display="flex" alignItems="center" gap={0.5}>
                      ...
                      <Typography variant="body1">
                        {dayjs(activeSprint.startDate).format('MMM D')} - {dayjs(activeSprint.endDate).format('MMM D, YYYY')}
                      </Typography>
                    </Box>
                    <Chip 
                  ...
                  <Box mb={2}>
                    <Box display="flex" justifyContent="between" mb={1}>
                      ...
                      <Typography variant="body2">
                        {((progress.daysPassed / progress.totalDays) * 100).toFixed(0)}%
                      </Typography>
                    </Box>
                    <LinearProgress 
                      variant="determinate" 
          ...
          <Card sx={{ height: '100%' }}>
            <CardContent sx={{ p: 3 }}>
              ...
              <Stack spacing={2}>
                ...
                >
                  {hasCheckedInToday ? "✅ Update Daily Check-in" : "📝 Daily Check-in"}
                </Button>
        ...
        <Grid item xs={12}>
          {hasCheckedInToday ? (
            ...
            >
              ⏰ Don't forget your daily check-in to track your progress and stay on target
            </Alert>
          )}
        </Grid>
      </Grid>
